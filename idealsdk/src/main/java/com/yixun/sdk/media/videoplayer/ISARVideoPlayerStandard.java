 ...
 * 包括具体的界面逻辑控制
 */
public class ISARVideoPlayerStandard extends ISARVideoPlayer {

    protected static Timer DISMISS_CONTROL_VIEW_TIMER;

    public ImageView backButton, share, save;
    ...
    public ISARVideoPlayerStandard(Context context) {
        super(context);
    }

    public ISARVideoPlayerStandard(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (!mChangePosition && !mChangeVolume) {
                        onEvent(ISARUserActionStandard.ON_CLICK_BLANK);
                        onClickUiToggle();
                    }
                    break;
            }
        ...
        if (i == R.id.thumb) {
            ...
            if (currentState == CURRENT_STATE_NORMAL) {
                if (!url.startsWith("file") && !url.startsWith("/") &&
                        !ISARUtils.isWifiConnected(getContext()) && !WIFI_TIP_DIALOG_SHOWED) {
                    showWifiDialog();
                    return;
                }
                startVideo();
            ...
            if (url.startsWith("file")) {
                ...
                Logger.LOGD(TAG + " realUrl : " + realUrl);
                ISARFilesUtil.saveVideoFileToAlbum(getContext(), realUrl);
            } else {
                Logger.LOGD(TAG + " the video is not local video!");
            }
        }
    }
    ...
    private void showShareDialog() {
        if (mBottomSheetDialog == null) {
            ...
            View view = LayoutInflater.from(getContext()).inflate(R.layout.bottom_sheet_share_dialog, null);
    ...
    public void startVideo() {
        prepareMediaPlayer();
        onEvent(ISARUserActionStandard.ON_CLICK_START_THUMB);
    }
