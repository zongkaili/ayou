 ...
 */
public class ISARResizeTextureView extends TextureView {
    protected static final String TAG = ISARResizeTextureView.class.getSimpleName();

    // x as width, y as height
    protected Point mVideoSize;

    public ISARResizeTextureView(Context context) {
        super(context);
        init();
    }

    public ISARResizeTextureView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
