 ...
 * Manage UI
 */
public class ISARVideoPlayerSimple extends ISARVideoPlayer {

    public ISARVideoPlayerSimple(Context context) {
        super(context);
    }

    public ISARVideoPlayerSimple(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
