...
import com.yixun.sdk.media.ISARDownloadThread;
import com.yixun.sdk.media.ISARDownloadThread.DownloadUpdateListener;
import com.yixun.sdk.media.ISARGL2JNILib;
import com.yixun.sdk.media.player.DemoPlayer;
import com.yixun.sdk.media.player.DemoPlayer.Listener;
import com.yixun.sdk.media.player.DemoPlayer.RendererBuilder;
import com.yixun.sdk.media.player.ExtractorRendererBuilder;
import com.yixun.sdk.media.player.HlsRendererBuilder;
...
/*    public boolean onError(MediaPlayer mp, int what, int extra) {
    ...
    Listener demoListener = new Listener() {
