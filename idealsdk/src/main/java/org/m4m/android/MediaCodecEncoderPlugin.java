...
//                Logger.LOGD(TAG + " select codec type=" + type);
            }
        }
        return null;
    }
    ...
    public ISurface createInputSurface() {
        Logger.LOGD(TAG + " Hongen MediaCodecEncoderPlugin createInputSurface");
        return new Surface(mediaCodec, eglUtil);
    }

    @Override
    public ISurface createSimpleInputSurface(IEglContext eglSharedContext) {
        Logger.LOGD(TAG + " Hongen MediaCodecEncoderPlugin createSimpleInputSurface");
    ...
    public void queueInputBuffer(int index, int offset, int size, long presentationTimeUs, int flags) {
        Logger.LOGI(TAG + " mediaCodec.queueInputBuffer("
    ...
    public int dequeueInputBuffer(long timeout) {
        //Logger.LOGI(TAG + " mediaCodec.dequeueInputBuffer()+");
        int index = mediaCodec.dequeueInputBuffer(timeout);
        //Logger.LOGI(TAG + " mediaCodec.dequeueInputBuffer()= "+ index);
        return index;
    }
    ...
    public void signalEndOfInputStream() {
        Logger.LOGI(TAG + " mediaCodec.signalEndOfInputStream();");
        mediaCodec.signalEndOfInputStream();
    }

    @Override
    public void stop() {
        Logger.LOGI(TAG + " mediaCodec.stop();");
        mediaCodec.stop();
    }

    @Override
    public void release() {
        Logger.LOGI(TAG + " mediaCodec.release();");
        mediaCodec.release();
    }
