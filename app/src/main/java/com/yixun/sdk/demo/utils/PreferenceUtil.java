...
import com.yixun.sdk.demo.DemoApplication;
...
public final class PreferenceUtil {
    ...
    public static String getString(String key, String defValue) {
        ...
        return PreferenceManager.getDefaultSharedPreferences(DemoApplication.getInstance())
    ...
    public static void putStringProcess(String key, String value) {
        ...
        SharedPreferences sharedPreferences = DemoApplication.getInstance()
